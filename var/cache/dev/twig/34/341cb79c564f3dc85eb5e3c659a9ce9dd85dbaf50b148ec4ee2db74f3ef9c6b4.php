...
class __TwigTemplate_050e41143959928694d6eaf2b67a4e133f2b64ea3649645f3bb94e86dd775f13 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 5
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 5, $this->source); })()), "email", [], "any", false, false, false, 5), 'widget');
        echo "
    <div>
...
";
    ...
    {
        return array (  64 => 9,  59 => 7,  54 => 5,  50 => 4,  46 => 3,  43 => 2,);
    }
...
{{ form_end(form) }}
", "@FOSUser/Registration/register_content.html.twig", "C:\\xampp\\htdocs\\pirate\\templates\\bundles\\FOSUserbundle\\Registration\\register_content.html.twig");
    }
}
