...
class __TwigTemplate_9abd68fd63a4049bc79a5963ef620138a366d0f719abb95be26cf0681fd11126 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-group\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produits"]) {
            ...
            echo "                                                
                        <span class=\"js-likes\">";
            // line 37
            echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produits"], "likes", [], "any", false, false, false, 37)), "html", null, true);
            echo "</span>
...
";
    ...
    {
        return array (  204 => 47,  194 => 46,  184 => 10,  175 => 7,  172 => 6,  167 => 5,  157 => 4,  146 => 44,  133 => 37,  130 => 36,  126 => 35,  122 => 33,  120 => 32,  116 => 31,  109 => 27,  101 => 25,  95 => 22,  90 => 20,  85 => 17,  81 => 16,  73 => 10,  70 => 4,  60 => 3,  37 => 1,);
    }
            ...
            <div class=\"col-4 mt-4\">
                <div class=\"border border-dark rounded p-2 clearfix\">
                    ...
                    <a href=\"{{ path('produits_like', {'id': produits.id}) }}\" class=\"btn btn-link js-like\">
                        ...
                        {% endif %}                                                
                        <span class=\"js-likes\">{{ produits.likes | length }}</span>
                        <span class=\"js-label\">J'aime</span>
                    </a>
                </div>
