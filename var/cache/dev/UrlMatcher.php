...
return [
    ...
    [ // $staticRoutes
        ...
        '/command' => [[['_route' => 'command', '_controller' => 'App\\Controller\\CommandController::getPanier'], null, null, null, false, false, null]],
        '/formulaire' => [[['_route' => 'formulaire', '_controller' => 'App\\Controller\\FormulaireController::index'], null, null, null, false, false, null]],
        '/paiement' => [[['_route' => 'paiement', '_controller' => 'App\\Controller\\PaiementController::getPanier'], null, null, null, false, false, null]],
        '/panier' => [[['_route' => 'panier_index', '_controller' => 'App\\Controller\\PanierController::index'], null, null, null, false, false, null]],
        '/pirate' => [[['_route' => 'pirate', '_controller' => 'App\\Controller\\PirateController::index'], null, null, null, false, false, null]],
        '/produits' => [[['_route' => 'produits', '_controller' => 'App\\Controller\\ProduitsController::index'], null, null, null, false, false, null]],
        '/send' => [[['_route' => 'send', '_controller' => 'App\\Controller\\SendController::index'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        195 => [[['_route' => 'panier_add', '_controller' => 'App\\Controller\\PanierController::addPanier'], ['id'], null, null, false, true, null]],
        218 => [[['_route' => 'panier_remove', '_controller' => 'App\\Controller\\PanierController::removeProduits'], ['id'], null, null, false, true, null]],
        243 => [[['_route' => 'panier_subtract', '_controller' => 'App\\Controller\\PanierController::subtractProduits'], ['id'], null, null, false, true, null]],
        273 => [[['_route' => 'produits_like', '_controller' => 'App\\Controller\\ProduitsController::like'], ['id'], null, null, false, false, null]],
        311 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        341 => [
